...
const CONTRIBUTORS = {
  "amara-okeke": { id:"amara-okeke", name:"Serg Mascot", role:"Open finalist, 2024", region:"Abakaliki, Nigeria",
  ...
  "daniyal-r": { id:"daniyal-r", name:"Daniyal Rahman", role:"WSDC, 2x national team", region:"Karachi, Pakistan",
  ...
  "mei-tan": { id:"mei-tan", name:"Mei Tan", role:"Adjudicator, AP & BP", region:"Singapore",
  ...
  "joaquin-vega": { id:"joaquin-vega", name:"Joaquín Vega", role:"Coach", region:"Lima, Peru",
  ...
  "priya-n": { id:"priya-n", name:"Priya Nair", role:"Two-time octofinalist", region:"Nairobi, Kenya",
    bio:"Priya writes about burnout, ambition, and the quiet years after you stop winning.",
    based:"Public-health researcher." },
  "adaeze-o": { id:"adaeze-o", name:"Adaeze Okonkwo", role:"WUDC Adjudicator, EA Circuit", region:"Lagos, Nigeria",
  ...
  "lena-park": { id:"lena-park", name:"Lena Park", role:"KPDC champion, 2022", region:"Seoul, South Korea",
